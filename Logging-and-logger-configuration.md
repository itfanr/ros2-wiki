...
```
ros2 service call --once /config_logger logging_demo/ConfigLogger "{logger_name: 'logger_usage_demo', level: INFO}"
```
...
```
ros2 service call --once /config_logger logging_demo/ConfigLogger "{logger_name: 'rcl', level: DEBUG}"
```
...
Shell 2:
```
ros2 service call --once /config_logger logging_demo/ConfigLogger "{logger_name: '', level: DEBUG}"
```
